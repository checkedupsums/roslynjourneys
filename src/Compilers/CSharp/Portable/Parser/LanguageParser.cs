...
#nullable disable
        ...
        {
            var tokenKeyword = this.EatToken(SyntaxKind.UnsafeKeyword);

            //tokenKeyword = this.AddErrorAsWarning(tokenKeyword, ErrorCode.ERR_SyntaxError, "Unsafe not needed as we have compiler allowunsafe flag enabled.\r\nPlease use safe or remove this block.");
