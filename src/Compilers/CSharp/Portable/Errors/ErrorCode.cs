...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal enum ErrorCode
    {
        ...
        ERR_BadIndexCount = 9,
        ERR_BadUnaryOp = 10,
        ERR_BadVisParamType = 11,
        ERR_BadVisFieldType = 12,
        ERR_BadVisPropertyType = 13,
        ERR_BadVisIndexerReturn = 14,
        ERR_BadVisIndexerParam = 15,
        ERR_BadVisOpReturn = 16,
        ERR_BadVisOpParam = 17,
        ERR_BadVisDelegateReturn = 18,
        ERR_BadVisDelegateParam = 19,
        ERR_BadVisBaseClass = 20,
        ERR_BadVisBaseInterface = 21,
        ERR_BadVisReturnType = 22,
        ERR_EventNeedsBothAccessors = 23,
        ERR_EventNotDelegate = 24,
        WRN_UnreferencedEvent = 25,
        ...
        ERR_GlobalSingleTypeNameNotFound = 32,
        ERR_TypeVarCantBeNull = 33,
        ERR_AmbigBinaryOps = 34,
        ERR_AmbigUnaryOp = 35,
        ERR_InAttrOnOutParam = 36,
        ERR_ValueCantBeNull = 37,
        ERR_InterfaceEventInitializer = 38,
        ERR_NoExplicitBuiltinConv = 39, // Requires SymbolDistinguisher.
        ERR_BadEventUsage = 40,
        ERR_ExplicitEventFieldImpl = 41,
        ERR_CantOverrideNonEvent = 42,
        ERR_AddRemoveMustHaveBody = 43,
        ERR_AbstractEventInitializer = 44,
        ERR_PossibleBadNegCast = 45,
        ERR_ReservedEnumerator = 46,
        ERR_AsMustHaveReferenceType = 47,
        WRN_LowercaseEllSuffix = 48,
        ERR_BadEventUsageNoField = 49,
        ERR_DuplicateParamName = 50,
        ERR_DuplicateNameInNS = 51,
        ERR_DuplicateNameInClass = 52,
        ERR_NameNotInContext = 53,
        ERR_AmbigContext = 54,
        WRN_DuplicateUsing = 55,
        ERR_BadMemberFlag = 56,
        ERR_BadMemberProtection = 57,
        WRN_NewRequired = 58,
        WRN_NewNotRequired = 59,
        ERR_CircConstValue = 60,
        ERR_MemberAlreadyExists = 61,
        ERR_StaticNotVirtual = 62,
        ERR_OverrideNotNew = 63,
        WRN_NewOrOverrideExpected = 64,
        ERR_OverrideNotExpected = 65,
        ERR_NamespaceUnexpected = 66,
        ERR_NoSuchMember = 67,
        ERR_BadSKknown = 68,
        ERR_BadSKunknown = 69,
        ERR_ObjectRequired = 70,
        ERR_AmbigCall = 71,
        ERR_BadAccess = 72,
        ERR_MethDelegateMismatch = 73,
        ERR_DuplicateAttribute = 74,
        ERR_BadExternAlias = 75,
        ERR_RetObjectRequired = 76,
        ERR_RetNoObjectRequired = 77,
        ERR_LocalDuplicate = 78,
        WRN_MainCantBeGeneric = 79,
        ERR_AssgLvalueExpected = 81,
        ERR_StaticConstParam = 82,
        ERR_NotConstantExpression = 83,
        ERR_NotNullConstRefField = 84,
        ERR_ColColWithTypeAlias = 85,
        ERR_LocalIllegallyOverrides = 86,
        ERR_BadUsingNamespace = 87,
        ERR_NoBreakOrCont = 88,
        ERR_DuplicateLabel = 89,
        ERR_AliasNotFound = 90,
        ERR_SameFullNameAggAgg = 91,
        ERR_SameFullNameNsAgg = 92,
        WRN_SameFullNameThisNsAgg = 93,
        WRN_SameFullNameThisAggAgg = 94,
        WRN_SameFullNameThisAggNs = 95,
        ERR_SameFullNameThisAggThisNs = 96,
        ERR_ExternAfterElements = 97,
        ERR_BadDelegateConstructor = 98,
        ERR_MethodNameExpected = 99,
        ERR_ConstantExpected = 100,
        ERR_V6SwitchGoverningTypeValueExpected = 101,
        ERR_DuplicateCaseLabel = 102,
        ERR_InvalidGotoCase = 103,
        ERR_PropertyLacksGet = 104,
        ERR_BadExceptionType = 105,
        ERR_BadEmptyThrow = 106,
        ERR_BadFinallyLeave = 107,
        ERR_LabelShadow = 108,
        ERR_LabelNotFound = 109,
        ERR_UnreachableCatch = 110,
        ERR_ReturnExpected = 111,
        WRN_UnreachableCode = 112,
        ERR_SwitchFallThrough = 113,
        WRN_UnreferencedLabel = 114,
        ERR_UseDefViolation = 115,
        ERR_NoConstructors = 116,
        ERR_UseDefViolationThisUnsupportedVersion = 117,
        WRN_UnreferencedVar = 118,
        WRN_UnreferencedField = 119,
        ERR_UseDefViolationField = 120,
        ERR_UnassignedThisUnsupportedVersion = 121,
        ERR_AmbigQM = 122,
        ERR_InvalidQM = 123, // Requires SymbolDistinguisher.
        ERR_NoBaseClass = 124,
        ERR_BaseIllegal = 125,
        ERR_ObjectProhibited = 126,
        ERR_ParamUnassigned = 127,
        ERR_InvalidArray = 128,
        ERR_ExternHasBody = 129,
        ...
        ERR_NoNewAbstract = 187,
        ERR_ConstValueRequired = 188,
        ERR_CircularBase = 189,
        ERR_ArgsInvalid = 190,
        ERR_AssgReadonly = 191,
        ERR_RefReadonly = 192,
        ERR_PtrExpected = 193,
        WRN_GlobalAliasDefn = 194,
        ERR_SealedStaticClass = 195,
        ...
        ERR_PrivateAbstractAccessor = 203,
        ERR_TooManyLocals = 204,
        ERR_AbstractBaseCall = 205,
        ERR_RefProperty = 206,
        ERR_ConstraintOnlyAllowedOnGenericDecl = 207,
        ERR_ManagedAddr = 208,
        ...
        ERR_CannotUseRefInUnmanagedCallersOnly = 222,
        ERR_SizeofUnsafe = 223,
        ERR_BadVarargs = 224,
        ERR_ParamsMustBeCollection = 225,
        ERR_IllegalArglist = 226,
        WRN_UnsafeUnneeded = 227,
        ERR_TypeParamMustBeIdentifier = 228,
        ERR_AmbigMember = 229,
        ERR_BadForeachDecl = 230,
        ERR_ParamsLast = 231,
        ERR_BadDirectivePlacement = 232,
        ERR_IdentifierExpectedKW = 233,
        ERR_DottedTypeNameNotFoundInNS = 234,
        ERR_SemiOrLBraceExpected = 235,
        ERR_FieldInitRefNonstatic = 236,
        ERR_SealedNonOverride = 238,
        ERR_CantOverrideSealed = 239,
        ERR_MemberReserved = 240,
        ERR_DuplicateBound = 241,
        ERR_VoidError = 242,
        ...
        ERR_ValueExpected = 256,
        ERR_VarargsLast = 257,
        ERR_MultiTypeInDeclaration = 258,
        ERR_AddOrRemoveExpected = 259,
        ...
        ERR_UnexpectedCharacter = 284,
        ERR_ProtectedInStatic = 285,
        WRN_UnreachableGeneralCatch = 286,
        ERR_IncrementLvalueExpected = 287,
        ERR_CantOverrideBogusMethod = 288,
        ERR_NoSuchMemberOrExtension = 289,
        WRN_DeprecatedCollectionInitAddStr = 290,
        ERR_DeprecatedCollectionInitAddStr = 291,
        WRN_DeprecatedCollectionInitAdd = 292,
        ERR_DefaultValueNotAllowed = 293,
        WRN_DefaultValueForUnconsumedLocation = 294,
        ERR_PartialWrongTypeParamsVariance = 295,
        ERR_GlobalSingleTypeNameNotFoundFwd = 296,
        ERR_DottedTypeNameNotFoundInNSFwd = 297,
        ERR_SingleTypeNameNotFoundFwd = 298,
        ERR_AbstractField = 299,
        ERR_BogusExplicitImpl = 300,
        ERR_ExplicitMethodImplAccessor = 301,
        WRN_CoClassWithoutComImport = 302,
        WRN_FailedInclude = 303,
        ERR_NoNewTyvar = 304,
        ERR_BadArity = 305,
        ...
        ERR_BadRetType = 317,
        WRN_NubExprIsConstBool = 318,
        WRN_ExplicitImplCollision = 319,
        ERR_DuplicateConstraintClause = 320,
        ERR_ComImportWithImpl = 321,
        ERR_ComImportWithBase = 322,
        ERR_ImplBadConstraints = 323,
        ERR_DottedTypeNameNotFoundInAgg = 324,
        ERR_MethGrpToNonDel = 325,
        WRN_VolatileByRef = 326,
        WRN_GotoCaseShouldConvert = 327,
        ERR_MethodImplementingAccessor = 328,
        WRN_DebugFullNameTooLong = 329,                                 // Dev11 name: ERR_DebugFullNameTooLong
        ERR_ImplicitlyTypedVariableAssignedBadValue = 330,              // Dev10 name: ERR_ImplicitlyTypedLocalAssignedBadValue
        ERR_ImplicitlyTypedVariableWithNoInitializer = 331,             // Dev10 name: ERR_ImplicitlyTypedLocalWithNoInitializer
        ERR_ImplicitlyTypedVariableMultipleDeclarator = 332,            // Dev10 name: ERR_ImplicitlyTypedLocalMultipleDeclarator
        ERR_ImplicitlyTypedVariableAssignedArrayInitializer = 333,      // Dev10 name: ERR_ImplicitlyTypedLocalAssignedArrayInitializer
        ERR_ImplicitlyTypedLocalCannotBeFixed = 334,
        ERR_ImplicitlyTypedVariableCannotBeConst = 335,                 // Dev10 name: ERR_ImplicitlyTypedLocalCannotBeConst
        WRN_ExternCtorNoImplementation = 336,
        ERR_TypeVarNotFound = 337,
        ERR_ImplicitlyTypedArrayNoBestType = 338,
        ERR_AnonymousTypePropertyAssignedBadValue = 339,
        ERR_OverrideWithConstraints = 340,
        ERR_CantInferMethTypeArgs = 341,
        ERR_AmbigOverride = 342,
        ERR_DecConstError = 343,
        WRN_CmpAlwaysFalse = 344,
        WRN_FinalizeMethod = 345,
        ERR_ExplicitImplParams = 346,
        ERR_NewTyvarWithArgs = 347,
        ERR_AbstractSealedStatic = 348,
        WRN_AmbiguousXMLReference = 349,
        ERR_AbstractHasBody = 350,
        ERR_ConcreteMissingBody = 351,
        ERR_AbstractAndSealed = 352,
        ERR_AbstractNotVirtual = 353,
        ERR_StaticConstant = 354,
        ERR_CantOverrideNonFunction = 355,
        ERR_CantOverrideNonVirtual = 356,
        ERR_CantChangeAccessOnOverride = 357,
        ERR_CantChangeReturnTypeOnOverride = 358,
        ERR_CantDeriveFromSealedType = 359,
        ERR_OperatorCantReturnVoid = 360,
        ERR_InvalidAttributeArgument = 361,
        ERR_AttributeOnBadSymbolType = 362,
        ERR_ConditionalOnInterfaceMethod = 363,
        ERR_FloatOverflow = 364,
        ERR_InvalidReal = 365,
        ERR_ComImportWithoutUuidAttribute = 366,
        ERR_DllImportOnInvalidMethod = 367,
        ERR_InvalidNamedArgument = 368,
        ERR_CantCallSpecialMethod = 369,
        ERR_AbstractInConcreteClass = 370,
        WRN_UnreferencedFieldAssg = 371,
        ERR_LocalSameNameAsTypeParam = 372,
        ERR_AsWithTypeVar = 373,
        ERR_StaticConstructorWithExplicitConstructorCall = 374,
        ERR_StaticConstructorWithAccessModifiers = 375,
        ERR_RecursiveConstructorCall = 376,
        ERR_ObjectCallingBaseConstructor = 377,
        ERR_PredefinedTypeNotFound = 378,
        ERR_BindToBogus = 379,
        ERR_BadTypeReference = 380,
        ERR_BadDestructorName = 381,
        ERR_StructWithBaseConstructorCall = 382,
        ERR_StructLayoutCycle = 383,
        ERR_OnlyClassesCanContainDestructors = 384,
        ERR_InterfacesCantContainFields = 385,
        ERR_InterfacesCantContainConstructors = 386,
        ERR_NonInterfaceInInterfaceList = 387,
        ERR_DuplicateInterfaceInBaseList = 388,
        ERR_CycleInInterfaceInheritance = 389,
        ERR_BadIndexerNameAttr = 390,
        ERR_AttrArgWithTypeVars = 391,
        ERR_BadUnaryOperatorSignature = 392,
        ERR_BadBinaryOperatorSignature = 393,
        ERR_BadShiftOperatorSignature = 394,
        ERR_ConditionalOnSpecialMethod = 395,
        ERR_ConditionalMustReturnVoid = 396,
        ERR_InterfacesCantContainConversionOrEqualityOperators = 397,
        ERR_ConflictAliasAndMember = 398,
        ERR_BadIncDecSignature = 399,
        ERR_ExtensionMethodsDecl = 400,
        ERR_ExtensionAttrNotFound = 401,
        ERR_ExplicitExtension = 402,
        ERR_ValueTypeExtDelegate = 403,
        ERR_ExplicitParamArrayOrCollection = 404,
        WRN_BitwiseOrSignExtend = 405,
        ERR_VolatileStruct = 406,
        ERR_VolatileAndReadonly = 407,
        ERR_UnboxNotLValue = 408,
        ERR_AnonMethGrpInForEach = 409,
        ERR_ConditionalWithOutParam = 410,
        ERR_AccessorImplementingMethod = 411,
        ERR_AliasQualAsExpression = 412,
        ERR_DerivingFromATyVar = 413,
        WRN_InvalidInclude = 414,
        WRN_MissingXMLComment = 415,
        WRN_XMLParseIncludeError = 416,
        ERR_BadDelArgCount = 417,
        ERR_UnexpectedSemicolon = 418,
        ERR_MethodReturnCantBeRefAny = 419,
        ERR_CompileCancelled = 420,
        ERR_MethodArgCantBeRefAny = 421,
        ERR_AssgReadonlyLocal = 423,
        ERR_RefReadonlyLocal = 424,
        WRN_ALinkWarn = 425,
        ERR_CantUseRequiredAttribute = 426,
        ERR_NoModifiersOnAccessor = 427,
        ERR_ParamsCantBeWithModifier = 428,
        ERR_ReturnNotLValue = 429,
        ERR_MissingCoClass = 430,
        ERR_AmbiguousAttribute = 431,
        ERR_BadArgExtraRef = 432,
        ERR_BadCompatMode = 433,
        WRN_CmdOptionConflictsSource = 434,
        ERR_DelegateOnConditional = 435,
        ERR_CantMakeTempFile = 436,
        ERR_BadArgRef = 437,
        ERR_YieldInAnonMeth = 438,
        ERR_ReturnInIterator = 439,
        ERR_BadIteratorArgType = 440,
        ERR_BadIteratorReturn = 441,
        ERR_BadYieldInFinally = 442,
        ERR_BadYieldInTryOfCatch = 443,
        ERR_EmptyYield = 444,
        ERR_AnonDelegateCantUse = 445,
        ...
        ERR_BadThisParam = 558,
        ERR_UnexpectedToken = 559,
        WRN_IdentifierOrNumericLiteralExpected = 560,
        ERR_BadTypeforThis = 561,
        ERR_BadParamModThis = 562,
        ERR_BadExtensionMeth = 563,
        ERR_BadExtensionAgg = 564,
        ERR_DupParamMod = 565,
        ...
        ERR_DefaultMemberOnIndexedType = 634,
        WRN_TypeParameterSameAsOuterTypeParameter = 635,
        ...
        ERR_TypeVariableSameAsParent = 645,
        ERR_UnifyingInterfaceInstantiations = 646,
        ERR_TyVarNotFoundInConstraint = 647,
        ERR_BogusType = 648,
        ...
        ERR_DuplicateTypeParameter = 667,
        ...
        ERR_InvalidMemberDecl = 673,
        ERR_MemberNeedsType = 674,
        ERR_BadBaseType = 675,

        ERR_InvalidExprTerm = 677,
        ERR_NoNamespacePrivate = 678,
        ERR_BadVarDecl = 679,
        ERR_UsingAfterElements = 680,
        ERR_BadBinOpArgs = 681,
        ERR_BadArraySyntax = 682,
        ERR_BadOperatorSyntax = 683,
        ERR_IndexerNeedsParam = 684,
        ERR_MainClassNotFound = 685,
        ERR_MainClassNotClass = 686,
        ERR_OutputNeedsName = 687,
        ERR_NoMainInClass = 688,
        ERR_CantHaveWin32ResAndManifest = 689,
        ERR_CantHaveWin32ResAndIcon = 690,
        ERR_CantReadResource = 691,
        ERR_DocFileGen = 692,
        WRN_XMLParseError = 693,
        WRN_DuplicateParamTag = 694,
        WRN_UnmatchedParamTag = 695,
        WRN_MissingParamTag = 696,
        WRN_BadXMLRef = 697,
        ERR_BadStackAllocExpr = 698,
        ERR_InvalidLineNumber = 699,
        ERR_BadUnOpArgs = 700,
        ...
        ERR_ExplicitImplCollisionOnRefOut = 725,
        ERR_InvalidSpecifier = 726,
        ERR_IndirectRecursiveConstructorCall = 727,
        ...
        WRN_ObsoleteOverridingNonObsolete = 732,
        ERR_VariableUsedBeforeDeclaration = 733,
        ...
        ERR_ExpressionTreeContainsMultiDimensionalArrayInitializer = 752,
        ERR_IndexedPropertyMustHaveAllOptionalParams = 753,
        ...
        ERR_IndexedPropertyRequiresParams = 766,
        ERR_ExpressionTreeContainsNamedArgument = 767,
        ERR_ExpressionTreeContainsOptionalArgument = 768,
        ERR_ExpressionTreeContainsIndexedProperty = 769,
        ERR_ExpressionTreeContainsBaseAccess = 770,
        ERR_ExpressionTreeContainsAssignment = 771,
        ERR_AnonymousTypeDuplicatePropertyName = 772,
        ERR_StatementLambdaToExpressionTree = 773,
        ERR_ExpressionTreeMustHaveDelegate = 774,
        ERR_AnonymousTypeNotAvailable = 775,
        ERR_LambdaInIsAs = 776,
        ERR_MissingArgument = 777,
        ERR_UnassignedThisAutoPropertyUnsupportedVersion = 778,
        ERR_VariableUsedBeforeDeclarationAndHidesField = 779,
        ERR_ExpressionTreeContainsBadCoalesce = 780,
        ERR_ArrayInitializerExpected = 781,
        ERR_ArrayInitializerIncorrectLength = 782,
        ERR_OpenEndedComment = 783,
        ERR_OvlOperatorExpected = 784,
        ERR_EndRegionDirectiveExpected = 785,
        ERR_UnterminatedStringLit = 786,
        ERR_DuplicateAlias = 787,
        ERR_BadProtectedAccess = 788,
        ERR_AddModuleAssembly = 789,
        ERR_BindToBogusProp2 = 790,
        ERR_BindToBogusProp1 = 791,
        ...
        WRN_InvalidAssemblyName = 1200,
        WRN_UnifyReferenceMajMin = 1201,
        WRN_UnifyReferenceBldRev = 1202,
        ERR_DuplicateImport = 1203,
        ERR_DuplicateImportSimple = 1204,
        ERR_AssemblyMatchBadVersion = 1205,

        ERR_FixedNeedsLvalue = 1208,

        WRN_DuplicateTypeParamTag = 1210,
        WRN_UnmatchedTypeParamTag = 1211,
        WRN_MissingTypeParamTag = 1212,

        ERR_CantChangeTypeOnOverride = 1215,
        ERR_DoNotUseFixedBufferAttr = 1216,
        WRN_AssignmentToSelf = 1217,
        WRN_ComparisonToSelf = 1218,
        ERR_CantOpenWin32Res = 1219,
        WRN_DotOnDefault = 1220,
        ERR_NoMultipleInheritance = 1221,
        ERR_BaseClassMustBeFirst = 1222,
        WRN_BadXMLRefTypeVar = 1223,

        ERR_FriendAssemblyBadArgs = 1225,
        ERR_FriendAssemblySNReq = 1226,

        ERR_DelegateOnNullable = 1228,
        ERR_BadCtorArgCount = 1229,
        ERR_GlobalAttributesNotFirst = 1230,

        ERR_ExpressionExpected = 1233,
        WRN_UnmatchedParamRefTag = 1234,
        WRN_UnmatchedTypeParamRefTag = 1235,
        ERR_DefaultValueMustBeConstant = 1236,
        ERR_DefaultValueBeforeRequiredValue = 1237,
        ERR_NamedArgumentSpecificationBeforeFixedArgument = 1238,
        ERR_BadNamedArgument = 1239,
        ERR_DuplicateNamedArgument = 1240,
        ERR_RefOutDefaultValue = 1241,
        ERR_NamedArgumentForArray = 1242,
        ERR_DefaultValueForExtensionParameter = 1243,
        ERR_NamedArgumentUsedInPositional = 1244,
        ERR_DefaultValueUsedWithAttributes = 1245,
        ERR_BadNamedArgumentForDelegateInvoke = 1246,
        ERR_NoPIAAssemblyMissingAttribute = 1247,
        ERR_NoCanonicalView = 1248,
        //ERR_TypeNotFoundForNoPIA = 1249,
        ERR_NoConversionForDefaultParam = 1250,
        ERR_DefaultValueForParamsParameter = 1251,
        ERR_NewCoClassOnLink = 1252,
        ERR_NoPIANestedType = 1254,
        //ERR_InvalidTypeIdentifierConstructor = 1255,
        ERR_InteropTypeMissingAttribute = 1256,
        ERR_InteropStructContainsMethods = 1257,
        ERR_InteropTypesWithSameNameAndGuid = 1258,
        ERR_NoPIAAssemblyMissingAttributes = 1259,
        ERR_AssemblySpecifiedForLinkAndRef = 1260,
        ERR_LocalTypeNameClash = 1261,
        WRN_ReferencedAssemblyReferencesLinkedPIA = 1262,
        ERR_NotNullRefDefaultParameter = 1263,
        ERR_FixedLocalInLambda = 1264,
        // WRN_TypeNotFoundForNoPIAWarning = 1265,  // This error code is unused.
        ERR_MissingMethodOnSourceInterface = 1266,
        ERR_MissingSourceInterface = 1267,
        ERR_GenericsUsedInNoPIAType = 1268,
        ERR_GenericsUsedAcrossAssemblies = 1269,
        ERR_NoConversionForNubDefaultParam = 1270,
        //ERR_MemberWithGenericsUsedAcrossAssemblies = 1271,
        //ERR_GenericsUsedInBaseTypeAcrossAssemblies = 1272,
        ERR_InvalidSubsystemVersion = 1273,
        ERR_InteropMethodWithBody = 1274,
        // unused 1275-1899
        ...
        // Added in VS 12.1. Technically a breaking change, but the code it breaks was already guaranteed to throw
        // at runtime.
